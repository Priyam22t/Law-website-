    ...
    <>
        ...
        <div className="testimonials">
          <div className="leftt">
            ...
            <span className="font-bold text-blue-600 hover:text-blue-900">Thurgood </span>
            <span className="font-bold text-blue-800 text-2xl">Marshallr</span>
            <span>{list1[4].title}</span>
          </div>
          <div className="rightt">
            <div></div>
            <div></div>
            <img src={list1[4].image} alt="" />
          </div>
        </div>
        <Pricing />
        <Footer />
